...
import {CreateUpdateNewBrand, FillUpFormRequest} from "../../APIRequest/BrandApiRequest.js";
import {store} from "../../Redux/store/store.js";
import {resetFormValue, setFormValue} from "../../Redux/state-slice/brand-slice.js";

const CreateUpdateBrandList = () => {
    ...
    const doChange = async () => {
        if (isEmpty(FormValue['name'])) {
            ...
            const res = await CreateUpdateNewBrand(FormValue, objectId);
            if (res) {
...
export default CreateUpdateBrandList;
