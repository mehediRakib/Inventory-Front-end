...
import {resetFormValue, setFormValue} from "../../Redux/state-slice/customer-slice.js";
import {CreateNewCustomer, FillUpFormRequest} from "../../APIRequest/CustomerAPIRequest.js";
...
const CustomerCreateUpdate = () => {
    ...
    const doChange = async () => {
        if (isEmpty(FormValue.customerName)) {
            ...
            const res = await CreateNewCustomer(FormValue,objectId);
            if (res) {
                        ...
                        <div className="">
                            ...
                            <div className="grid grid-cols-3 gap-4 w-full pt-8">
                                <div className="space-y-1">
                                    ...
                                    <input onChange={(e) => {
                                        store.dispatch(setFormValue({name: 'customerName', value: e.target.value}))
